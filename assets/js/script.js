...
//<!-- =============================================== -->
	...
	jQuery(window).scroll(function () {
	  ...
	  if (top > batas) {
        ...
        jQuery('.navbar-brand img').css('width','50%');
        //jQuery('.navbar-brand img').animate({width: '50%'});
	  } else {
	   jQuery('.main-menu').removeClass('tiny'); 
       jQuery('.navbar-brand img').css('width','70%');
       //jQuery('.navbar-brand img').animate({width: '70%'});
	  }
	});
